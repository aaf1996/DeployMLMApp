    ...
    var t = $(window).width(),
        ...
        c = function () {
            $(".nav-control").on("click", function () {
                ...
                const isHamburgerActive = $(".hamburger").hasClass("is-active");
                if (innerWidth < 768 && isHamburgerActive) {
                    $(".nav-header .brand-logo").css("left", "0%");
                    $(".nav-header").css("width", "231px");
                }
                else if (innerWidth < 768 && !isHamburgerActive) {
                    $(".nav-header .brand-logo").css("left", "-100%");
                    $(".nav-header").css("width", "1rem");
                }
            })
        },
        i = function () {
