ns('MLM.Site.Header.Logout')
MLM.Site.Header.Logout.Controller = function () {
    var base = this;
    ...
    base.Event = {
        ...
        AjaxLogoutSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
                    window.location.href = MLM.Site.Header.Actions.RedirectLogin;
                }
            }
        },
    ...
    base.Ajax = {
        AjaxLogout: new MLM.Site.UI.Web.Components.Ajax({
            action: MLM.Site.Header.Actions.LogoutSession,
            autoSubmit: false,
            onSuccess: base.Event.AjaxLogoutSuccess
        }),
        AjaxGetLogin: new MLM.Site.UI.Web.Components.Ajax({
            action: MLM.Site.Header.Actions.GetLogin,
            autoSubmit: false,
